        ...
        <div className="col-md-8">
          ...
          <div className="row">
            <div className="col-md-12 d-flex flex-column justify-content-center align-items-center">
              ...
              <Link to="/forgot" className="btn forgot btn-outline-info mb-3">
                Forgot Password
              </Link>
              <Link to="/signup" className="btn forgot btn-outline-primary">
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <span className="mx-5"> Email : reshma9298h@gmail.com</span>{" "}
              <br />
