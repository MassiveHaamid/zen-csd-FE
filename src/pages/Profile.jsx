...
const Profile = () => {
  const { handleProfileUpdate, loggedUser, isLoading, handleHead } =
  ...
  return (
      ...
      {(formik) => (
      <Form>
      <div className="dtlCards">
      <h3 style={{ color: "var(--theme" }}>Profile Details :</h3>
      <TextField label="First Name" name="name" id="name" type="text" placeholder="Enter First Name"/>
      <TextField label="Last Name" name="lName" id="lName" type="text" placeholder="Enter Last Name"/>
      <TextField label="Email" name="email" id="email" type="email" disabled/>
      <TextField label="Contact No" name="contactNo" id="contactNo" type="text" placeholder="Enter Contact No."/>
      <TextField label="Batch" name="batch" id="batch" type="text" disabled/>
      <TextField label="Experience" name="experience" id="experience" type="text" placeholder="Enter Experience in Years"/>
      <TextField label="Qualification" name="qualification" id="qualification" type="text" placeholder="Enter Qualification"/>
