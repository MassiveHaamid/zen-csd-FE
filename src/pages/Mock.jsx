                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    ...
                    <div className="mock__Data mb-1">
                      ...
                      <div className="mock__details">{data.interviewDate}</div>
                    </div>
                    <div className="mock__Data mb-1">
                      <div className="mock__title d-flex justify-content-between px-1">
                    ...
                    <div className="mock__Data mb-1">
                      ...
                      <div className="mock__details">{data.interviewRound}</div>
                    </div>
                    <div className="mock__Data mb-1">
                      <div className="mock__title d-flex justify-content-between px-1">
                        Attended <span>:</span>
                      </div>
                      <div className="mock__details">{data.attended}</div>
                    </div>
                    <div className="mock__Data mb-1">
                      <div className="mock__title d-flex justify-content-between px-1">
                        Comments <span>:</span>
                      </div>
                      <div className="mock__details">{data.comment}</div>
                    </div>
                    <div className="mock__Data mb-1">
                      <div className="mock__title d-flex justify-content-between px-1">
                        Logical Score <span>:</span>
                      </div>
                      <div className="mock__details">{data.logicalScore}</div>
                    </div>
                    <div className="mock__Data mb-1">
                      <div className="mock__title d-flex justify-content-between px-1">
                        Overall Score <span>:</span>
                      </div>
                      <div className="mock__details">{data.overallScore}</div>
                    </div>
                    <div className="mock__Data mb-1">
                      <div className="mock__title d-flex justify-content-between align-items-center px-1">
                        recordingURL <span>:</span>
                      </div>
                      <div className="mock__details">{data.recordingURL}</div>
                    </div>
                  </div>
